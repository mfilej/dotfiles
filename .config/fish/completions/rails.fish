# Adapted from https://github.com/hornairs/hook/blob/ee47c9ec054ae52327d6127b3842eaadcc756e43/rails/completions/rails.fish
# Commands
...
complete -f -c rails -n '__fish_rails_using_command new' -s B -l skip-bundle         -x -d 'Don\'t run bundle install'
